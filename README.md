...
**研究数据库已进入主线建设。** 2026-08-28的 AKShare／东方财富快照观察到94只 C-REIT，其中9只证券名称和资产类型已有一手来源人工核验。沪深官方公告目录已收录8,151条元数据，覆盖94／94只证券。当前508026有36条连续季度经营观测；三类资产规范种子有20条真实观测。正式登记来源文档增至67份且均已计算 SHA-256；508018形成2022Q2—2026Q2连续17季度报告序列，508056形成2021Q3—2026Q2连续20季度报告序列。仓库不保存原始 PDF。详见 [数据库当前状态](docs/database_status.md)、[研究数据库设计](docs/database_design.md)和[数据字典](docs/data_dictionary.md)。
