...
**研究数据库已形成能源纵向试点。** 2026-08-28的 AKShare／东方财富快照观察到94只 C-REIT，其中9只证券名称和资产类型已有一手来源人工核验。沪深官方公告目录已收录8,151条元数据，覆盖94／94只证券。当前508026有36条连续季度经营观测；三类资产规范种子有20条真实观测。能源横截面覆盖3只REIT、6项底层资产和39条2026Q2经营观测；三条能源纵向面板合计307条：508028海上风电86条、508096光伏／扩募水电146条、180401燃气发电75条。能源面板使用的43份季度／年度报告均进入人工复核台账，最新季度已与横截面样本交叉核对。508096年报还形成3条可复现的历史修订版本。2025年季度—年报勾稽共27项：16项完全一致、10项属于披露精度差异、1项为无法可靠分摊到单季的年报调整。正式登记来源文档共128份且均已计算 SHA-256，其中能源类61份。仓库不保存原始 PDF。详见 [数据库当前状态](docs/database_status.md)、[能源扩面结论](docs/energy_database_findings.md)、[研究数据库设计](docs/database_design.md)和[数据字典](docs/data_dictionary.md)。
