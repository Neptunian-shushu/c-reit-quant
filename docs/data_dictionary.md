...
- `reit_asset_type_evidence.csv`：95只证券的官方标题或人工核验资产类型证据；
- `reit_security_data_coverage.csv`：全市场上市、报告和分派候选覆盖；
- `reit_document_extraction_queue.csv`：1,626份正式报告／分派公告的解析状态；
