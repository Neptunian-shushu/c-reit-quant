...
Phase 0确认发电量和利用小时存在。Phase 1A已确认四项核心指标在2024Q2—2026Q2连续披露，并从招募说明书回填2013—2022年十个完整年度的上市前经营历史。季度上市后样本仍只有9期，但年度历史已经足以审计水文代理、指标口径和数据连接方法；正式预测模型仍需流域面雨量或更高频可信来水数据。详见 [Phase 1 水电试点结论](phase1_hydropower_findings.md)。
